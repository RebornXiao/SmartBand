...
public class PTEventHander {
    private Handler handler;
    public PTEventHander() {
        // Set up a handler to post events back to the correct thread if possible
        if(Looper.myLooper() != null) {
            handler = new Handler(){
                public void handleMessage(Message msg){
                	PTEventHander.this.handleMessage(msg);
                }
            };
        }
    ...
    protected void sendScanDeviceMessage(int nEvent) {//ɨ���豸
        sendMessage(obtainScanDeviceMessage(4, nEvent));
    }
    protected void sendScanDeviceSericeMessage(int nEvent) {//ɨ���豸����
        sendMessage(obtainScanDeviceSericeMessage(5, nEvent));
    }
    protected void sendPairDeviceMessage(int nEvent) {//ɨ���豸����
        sendMessage(obtainPairDeviceMessage(6, nEvent));
    }
    protected void sendConnectDeviceMessage(int nEvent) {//l��
